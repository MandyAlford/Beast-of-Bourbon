...
describe('App', () => {
  it('should render drink cards on the page', async() => {
    ...
    fetchDrinkRecipe.mockResolvedValueOnce({
      drinks: [
        {
            "idDrink": "11021",
            "strDrink": "Allegheny",
    ...
    fireEvent.click(getByText('Beast of Bourbon'))

    expect(getByText('Bourbon Sour')).toBeInTheDocument();
    fireEvent.click(getByText('Bourbon Sour'))
    await waitFor(() => fireEvent.click(getByText('Favorite')))
